...
COMMENT ON TABLE vendor_audit_logs IS
  'Append-only audit trail for vendor management actions.';

CREATE INDEX IF NOT EXISTS idx_vendor_audit_logs_vendor_id
  ON vendor_audit_logs (vendor_id);

CREATE INDEX IF NOT EXISTS idx_vendor_audit_logs_action
  ON vendor_audit_logs (action);

CREATE INDEX IF NOT EXISTS idx_vendor_audit_logs_changed_by
  ON vendor_audit_logs (changed_by);

CREATE INDEX IF NOT EXISTS idx_vendor_audit_logs_created_at
  ON vendor_audit_logs (created_at DESC);

CREATE INDEX IF NOT EXISTS idx_vendor_audit_logs_vendor_created_at
