...
CREATE TRIGGER set_inventory_pricing_updated_at BEFORE
...
CREATE INDEX idx_inventory_audit_logs_inventory_id ON inventory_audit_logs (inventory_id, changed_at DESC);
...
CREATE INDEX idx_inventory_stock_movements_inventory_id ON inventory_stock_movements (inventory_id, created_at DESC);

CREATE INDEX idx_inventory_stock_movements_branch_id ON inventory_stock_movements (branch_id, created_at DESC);
