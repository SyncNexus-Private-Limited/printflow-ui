...
CREATE INDEX idx_inv_pricing_audit_pricing_id ON inventory_pricing_audit_logs (inventory_pricing_id);

CREATE INDEX idx_inv_pricing_audit_branch_id ON inventory_pricing_audit_logs (branch_id);

CREATE INDEX idx_inv_pricing_audit_inventory_id ON inventory_pricing_audit_logs (inventory_id);

CREATE INDEX idx_inv_pricing_audit_changed_by ON inventory_pricing_audit_logs (changed_by);

CREATE INDEX idx_inv_pricing_audit_created_at ON inventory_pricing_audit_logs (created_at);

CREATE INDEX idx_inv_pricing_audit_pricing_id_created_at ON inventory_pricing_audit_logs (inventory_pricing_id, created_at DESC);
