...
CREATE INDEX idx_expense_category_audit_logs_expense_category_id ON expense_category_audit_logs (expense_category_id);

CREATE INDEX idx_expense_category_audit_logs_action ON expense_category_audit_logs (action);

CREATE INDEX idx_expense_category_audit_logs_changed_by ON expense_category_audit_logs (changed_by);

CREATE INDEX idx_expense_category_audit_logs_created_at ON expense_category_audit_logs (created_at DESC);

CREATE INDEX idx_expense_category_audit_logs_category_created_at ON expense_category_audit_logs (expense_category_id, created_at DESC);
