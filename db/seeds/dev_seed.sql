...
INSERT INTO branches (
  id, code, name, phone, alternate_phone, email, address, logo, banner, description, is_active
) VALUES
(
...
-- 2) USERS
INSERT INTO users (
  id, full_name, phone, alternate_phone, email, avatar, address, role, branch_id, is_active
) VALUES
(
...
INSERT INTO user_auth (
  user_id, username, password_hash, failed_attempts, is_locked, last_login
) VALUES
(
  '22222222-2222-4222-8222-222222222222',
  'admin',
...
-- 5) VENDORS
INSERT INTO vendors (
  id, vendor_code, name, avatar, phone, alternate_phone, address
) VALUES
(
...
INSERT INTO inventory (
  id, branch_id, sku, name, image, unit, is_active, quantity, last_purchase_rate, last_vendor_id
) VALUES
(
...
INSERT INTO inventory_pricing (
  id, branch_id, inventory_id, customer_type, selling_rate, effective_from, effective_to
) VALUES
(
...
INSERT INTO order_items (
  id, order_id, inventory_id, quantity, unit_price, line_total
) VALUES
(
...
INSERT INTO payments (
  id, order_id, branch_id, received_by, amount, mode, txn_reference
) VALUES
(
...
INSERT INTO order_vendors (
  id, order_id, vendor_id, vendor_paid_amount
) VALUES
(
...
INSERT INTO offer_items (
  id, branch_id, item_name, item_image, quantity_in_stock, total_ordered_qty, is_active
) VALUES
(
...
INSERT INTO order_offer_items (
  id, order_id, offer_item_id, qty
) VALUES
(
...
WHERE id = '88888888-1111-4111-8111-111111111111';
