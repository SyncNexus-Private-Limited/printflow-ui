...
import { offerFieldNames, offerTypeValues, type OfferFieldName } from "@/lib/offers/types";
...
export function buildOfferSchema(validCustomerTypes: readonly string[]) {
  return z
    .object({
      branchId: z
        .string()
      ...
      customerTypes: z
        .array(z.enum(validCustomerTypes as [string, ...string[]]))
        .default([])
        .refine(
...
export type OfferInput = z.infer<ReturnType<typeof buildOfferSchema>>;
